...
public class newGameManager : MonoBehaviour
{
    ...
    */
    public void BalanceFullSection(Dictionary<string,float> dictionary, float balanceValue)
    {
        Dictionary<string,float> temp = new Dictionary<string, float>(dictionary);
        foreach (KeyValuePair<string, float> kvp in temp)
        {
            dictionary[kvp.Key] = kvp.Value * balanceValue;
        }
    }
